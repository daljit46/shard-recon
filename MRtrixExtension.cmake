...
foreach(cmd_file ${PYTHON_COMMANDS})
    ...
    if(has_import GREATER -1)
        ...
        install(FILES ${PROJECT_BINARY_DIR}/mrtrix3/lib/mrtrix3/commands/${CMDNAME}.py DESTINATION mrtrix3/lib/mrtrix3/commands)
    else()
        file(COPY ${cmd_file}/ DESTINATION ${PROJECT_BINARY_DIR}/bin/${CMDNAME})
    endif()
    install(FILES ${PROJECT_BINARY_DIR}/bin/${CMDNAME} DESTINATION bin
